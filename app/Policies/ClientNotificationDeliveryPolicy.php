 ...
 */
final class ClientNotificationDeliveryPolicy
{
    ...
    public function view(User $user, ClientNotificationDelivery $delivery): bool
    {
    ...
    public function update(User $user, ClientNotificationDelivery $delivery): bool
    {
        return false;
    }

    public function delete(User $user, ClientNotificationDelivery $delivery): bool
    {
        return false;
    }
}
