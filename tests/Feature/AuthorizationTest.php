...
describe('permission-protected pages', function (): void {
    it('refuses a user without the permission', function (string $routeName, PermissionName $permission): void {
        ...
        'client attributes' => ['admin.client-attributes.index', PermissionName::ClientAttributesViewAny],
        'client attribute create' => ['admin.client-attributes.create', PermissionName::ClientAttributesCreate],
    ...
    */
    ...
    it('allows a user holding the permission', function (string $routeName): void {
        ...
        'admin.roles.index',
        'admin.client-attributes.index',
        'admin.client-attributes.create',
        'admin.roles.create',
